...
char **_reallocdp_handler(char **p, unsigned int o_size, unsigned int n_size);
...
void _add_nodes_handler(list_t **s_node_head, linel_t **ln_head, char *input);
...
char *_replaced_input_handler(var_t **head, char *input, char *r_in, int len);
